...
const StorageUtils = {
    async saveAnalysis(data) {
        ...
        return new Promise((resolve) => {
            browserAPI.storage.local.set({ lastAnalysis: safeMetadata }, () => {
    ...
    async getAnalysis() {
        return new Promise((resolve) => {
            browserAPI.storage.local.get(['lastAnalysis'], (result) => {
    ...
    async clearAnalysis() {
        return new Promise((resolve) => {
            browserAPI.storage.local.remove(['lastAnalysis'], () => {
                resolve(true);
            });
        });
    },
    ...
    async saveSettings(settings) {
        return new Promise((resolve) => {
            browserAPI.storage.local.set({ settings }, () => resolve(true));
        });
    }
};
